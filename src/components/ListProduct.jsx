...
function ListProduct({ products, url }) {
            ...
            <div style={{ width: "auto", paddingTop: "60px", marginTop: "46px" }}>
                {
                    products.map((product) => {
                        return <div className="list_products__product" key={product.id}>
                            <div className="list_products__product__image" style={{ backgroundImage: `url(${url+product.picture})`, borderRadius: "198.875px 198.875px 0px 0px", width: "100%", height: "413px", }}></div>
